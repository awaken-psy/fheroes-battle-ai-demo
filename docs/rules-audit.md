...
> ✅ 104 / ⚠️ 11 (近似/简化) / ❌ 0 (范围内) / 📄 11 (范围外)

**AI 决策覆盖率: 97%** (详见 `docs/ai-audit.md`)
...
|------|------|
| ✅ 完全对齐 | 295 项 (93%) |
| ⚠️ 近似实现 | 15 项 (5%) — 均为有意的简化决策,不影响核心玩法 |
| ❌ 缺失 | 0 项 (0%) |
| 📄 范围外 | 18 项 (6%) — 6 法术(复杂机制) + 1 英雄(Wisdom) + 11 AI(需新子系统) |
| 📊 AI 覆盖 | 97% 决策行为(104✅ + 11⚠️ + 11📄范围外) |
