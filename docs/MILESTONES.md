...
### A3 — 移动与目标选择 `planner.py`（下一步）

- [ ] §4.1-#2：射手撤退评估——`UnitRemover` 模式
- [ ] §5.1-#4：攻击位置按距当前单位距离排序
- [ ] §6.1-#5：被堵射手用 `BestAttackOutcome`
- [ ] §9-#2：`getClosestReachablePosition`
- [ ] §9-#5：宽体 `isHandFighting` 碰撞检测
- [ ] §8.4-#2：双格攻击方向评估
