...
from battle import Unit, BattleState
...
class Game:
    def __init__(self):
        ...
        # cached play-again rect for game-over click detection
    ...
    def _handle(self, ev):
        # translate mouse coords to canvas space (identity for native rendering)
        if self.state == SETUP:
    ...
    def start_battle(self):
        ...
        self.screen_battle._ph = 0  # PH_IDLE
        self.state = BATTLE
